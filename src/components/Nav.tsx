...
export default function Nav() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-[#0b1f4a] border-b border-white/10 z-50">
      <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="/deadlines" className="text-sm text-blue-200 hover:text-white transition-colors">Timelines</a>
          ...
          <a href="/#contact" className="bg-yellow-400 text-[#0b1f4a] text-sm px-5 py-2.5 rounded-full font-semibold hover:bg-yellow-300 transition-colors">
            Work with me
          </a>
        </div>
      ...
      {open && (
        <div className="md:hidden border-t border-white/10 px-6 py-4 flex flex-col gap-4 bg-[#0b1f4a]">
          <a href="/deadlines" onClick={() => setOpen(false)} className="text-sm text-blue-200">Timelines</a>
          ...
          <a href="/#contact" onClick={() => setOpen(false)} className="bg-yellow-400 text-[#0b1f4a] text-sm px-5 py-2.5 rounded-full font-semibold text-center">
            Work with me
          </a>
        </div>
      )}
