          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              <div className="relative z-10 rounded-2xl ring-4 ring-[#0b1f4a] aspect-[3/4] overflow-hidden">
                <Image
                  ...
                  fill
                  className="object-cover object-top saturate-[1.30] brightness-90"
                  priority
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-3 mt-1">
              ...
              <div className="bg-yellow-400 rounded-xl p-4 text-center">
                <div className="font-serif text-2xl font-semibold text-[#0b1f4a]">Bay Area</div>
                <div className="text-xs text-[#0b1f4a]/70 mt-0.5">local counselor</div>
              </div>
            </div>
          </div>
