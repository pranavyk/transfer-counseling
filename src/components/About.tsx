      ...
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 mb-4 leading-relaxed">
              As a transfer applicant, I was accepted to <strong>UC Berkeley, UCSD, and UIUC</strong>.
          ...
          <div className="bg-white rounded-2xl p-8 border border-gray-200 shadow-sm">
            ...
            <div className="text-gray-900 font-semibold mb-1">First-hand experience</div>
            <div className="text-gray-500 text-sm mb-8">Not theory — I did this myself.</div>
            <div className="space-y-6">
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-gray-600">UC Application Strategy</span>
                  <span className="font-medium">Expert</span>
                </div>
                <div className="h-2 bg-gray-100 rounded-full">
                  <div className="h-2 bg-blue-600 rounded-full w-[95%]" />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-gray-600">Personal Insight Questions</span>
                  <span className="font-medium">Expert</span>
                </div>
                <div className="h-2 bg-gray-100 rounded-full">
                  <div className="h-2 bg-blue-600 rounded-full w-[93%]" />
                </div>
              </div>
              <div>
                <div className="flex justify-between text-sm mb-2">
                  <span className="text-gray-600">Bay Area CC Curriculum</span>
                  <span className="font-medium">Expert</span>
                </div>
                <div className="h-2 bg-gray-100 rounded-full">
