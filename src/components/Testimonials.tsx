const testimonials = [
  {
    quote: "I had a 3.4 GPA and thought Berkeley was out of reach. After working through my essays and strategy, I got in. The process felt so much clearer.",
    name: "Michelle L.",
    detail: "Transferred to UC Berkeley — Computer Science",
  },
  {
    quote: "My son didn't know where to start with the TAG process. The roadmap we built together was incredibly clear and he got his guarantee to UC Davis.",
    name: "Parent — San Jose",
    ...
    <section id="testimonials" className="py-20 px-6 bg-white">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {testimonials.map((t) => (
            <div key={t.name} className="bg-gray-50 rounded-2xl p-7 border border-gray-200">
